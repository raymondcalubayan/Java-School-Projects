 ...
 * 
 * Description: This is the original Phone class from program 3. It will be reused in program 4 
 * with two new classes added.
 * 
 * Due Date: 11/1/18
 */
public class Phone {
	 ...
	 *  
	 * The toString method converts data members created in the class to a String.  
